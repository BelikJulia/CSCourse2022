...
namespace GradesPrototype.Data
{
    ...
    // Exercise 1: Task 1a: Create the User abstract class with the common functionality for Teachers and Students
    public abstract class User
    {
        // Exercise 1: Task 1b: Add the UserName property to the User class
        public string UserName { get; set; }
        // Exercise 1: Task 1c: Add the Password property to the User class
        ...
        // Exercise 1: Task 1d: Add the VerifyPassword method to the User class
    ...
    // Exercise 1: Task 2a: Inherit from the User class
    public class Student: User, IComparable<Student>
    {
        public int StudentID { get; set; }
        // Exercise 1: Task 2b: Remove the UserName property (now inherited from User)
        // Exercise 1: Task 2c: Remove the Password property (now inherited from User)
        // Exercise 1: Task 2d: Remove the VerifyPassword method (now inherited from User)
    ...
    // Exercise 1: Task 2e: Inherit from the User class
    public class Teacher: User
    {
        public int TeacherID { get; set; }
        // Exercise 1: Task 2f: Remove the UserName property (now inherited from User)
        // Exercise 1: Task 2g: Remove the Password property (now inherited from User)
        // Exercise 1: Task 2h: Remove the VerifyPassword method (now inherited from User)
        public string FirstName { get; set; }
        public string LastName { get; set; }
