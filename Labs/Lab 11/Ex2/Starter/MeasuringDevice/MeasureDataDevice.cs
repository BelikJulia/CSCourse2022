...
namespace MeasuringDevice
{
    public abstract class MeasureDataDevice : IEventEnabledMeasuringDevice, IDisposable
    {
        ...
        public void StartCollecting()
        {
            ...
            // Call StartHeartBeat() from StartCollecting method.
            StartHeartBeat();
            GetMeasurements();
       }
        ...
        public void Dispose()
        {
            ...
            // Dispose of the HeartBeatTimer BackgroundWorker.
        ...
        // Add the HeartBeatInterval property.
        ...
        // Declare the BackgroundWorker to generate the heartbeat.
        // Background worker object to host the heartbeat thread.
        private BackgroundWorker heartBeatTimer;

        // Create a method to configure the background Worker using Lambda Expressions.
