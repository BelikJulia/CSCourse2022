...
{
    // Modify the class definition to implement the extended interface.
    public abstract class MeasureDataDevice : IEventEnabledMeasuringDevice, IDisposable
    {
        ...
        // Declare a BackgroundWorker to generate data.
        ...
        public void StartCollecting()
        {
            ...
            // Call the GetMeasurements method.
            GetMeasurements();
        }

        // Implement the GetMeasurements method.
