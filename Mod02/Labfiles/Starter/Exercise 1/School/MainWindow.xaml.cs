    ...
    public partial class MainWindow : Window
    {
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Enter:
                    // Exercise 1: Task 1a: Copy code for editing the details for that student
                    Student student = this.studentsList.SelectedItem as Student;
                    // Exercise 1: Task 3d: Refactor as the EditStudent method
                    EditStudent(student);
                    break;

                // If the user pressed Insert, add a new student
                case Key.Insert:
                    // Exercise 1: Task 3a: Refactor as the addNewStudent method
                    AddnewStudent();
                    break;
                ...
                case Key.Delete: student = this.studentsList.SelectedItem as Student;
                    // Exercise 1: Task 3b: Refactor as the removeStudent method
                    RemoveStudent(student);
                    break;
            }
        }

        // Exercise 1: Task 3c: create Edit student method
