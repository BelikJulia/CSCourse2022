...
namespace GradesPrototype.Data
{
    ...
    public class Student: IComparable<Student>
    {
        ...
        // Exercise 4: Task 2c: Add a grade to a student (the grade is already populated)
    ...
    public class Teacher
    {
        ...
        public void EnrollInClass(Student stud)
        {
            if (stud.TeacherID == 0)
                stud.TeacherID = TeacherID;
            else
        ...
        public void RemoveFromClass(Student stud)
        {
            if (stud.TeacherID == TeacherID)
                stud.TeacherID = 0;
            else
