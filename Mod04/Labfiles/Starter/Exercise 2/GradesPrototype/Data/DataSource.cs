...
namespace GradesPrototype.Data
{
    ...
    public static class DataSource
    {
        ...
        // Exercise 2: Task 1a: Define a List collection for holding the names of valid subjects
        ...
        {
            // Exercise 2: Task 1b: Populate the list of valid subjects with sample data
