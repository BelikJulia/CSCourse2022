...
{
    // Exercise 2: Task 2a: Specify that the WordWrapper class implements the IDisposable interface
    public class WordWrapper : IDisposable
    {
        ...
        // Exercise 2: Task 2d: Create a finalizer that calls the Dispose method
        private bool isDisposed = false;
        // Exercise 2: Task 2b: Create the protected Dispose(bool) method
        ...
        // Exercise 2: Task 2c: Create the public Dispose method
        public void Dispose()
        {
            this.Dispose(true);
