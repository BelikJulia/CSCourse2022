            ...
            switch (e.Key)
            {
                ...
                case Key.Insert:
                    ...
                    if (sf.ShowDialog().Value)
                    {
                        ...
                        newstud.FirstName = sf.firstName.Text;
                        newstud.LastName = sf.lastName.Text;
                        newstud.DateOfBirth = DateTime.Parse(sf.dateOfBirth.Text, CultureInfo.InvariantCulture);
                        // Exercise 2: Task 4a: Assign the new student to the current teacher
                        this.teacher.Students.Add(newstud);
                        // Exercise 2: Task 4b: Add the student to the list displayed on the form
                        this.studentsInfo.Add(newstud);
