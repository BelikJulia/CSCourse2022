...
namespace GCD_Test_Project
{
    ...
    public class GCDAlgorithmsTest
    {
        ...
        {
            int a = 7396; // TODO: Initialize to an appropriate value
            int b = 1978; // TODO: Initialize to an appropriate value
            int c = 1204;
            int expected = 86; // TODO: Initialize to an appropriate value
            int actual;
